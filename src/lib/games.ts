...
/** 6-letter words for Word Scramble (all unique, all exactly 6 letters) */
export const SCRAMBLE_WORDS: string[] = [
  ...
  'MUFFIN','COOKIE','WAFFLE','NOODLE','PASTRY','YOGURT','CHEESE','PICKLE',
  'GARLIC','LYCHEE','PAPAYA','BAMBOO','COBALT','DAGGER','DESERT','GOBLIN',
  'HARBOR','LANCER','MARBLE','MEADOW','MORTAR','MUSCLE','MYSTIC','NECTAR',
  'ORCHID','AUTHOR','BANNER','CINDER','DIFFER','EDITOR','GLIDER','CHAPEL',
  'INSECT','JIGSAW','KITTEN','LOCKER','MALLET','NAPKIN','ORIGIN','PORTER',
  'QUIVER','RANGER','SORBET','TANGLE','DEVOUR','VENDOR','WIDGET','YONDER',
]
